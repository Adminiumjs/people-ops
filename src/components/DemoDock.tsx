...
export default function DemoDock() {
  ...
  if (!open) {
    return (
      <button
        type="button"
        className={`fp-dock__mini fp-btn${shifted ? " fp-dock--shifted" : ""}`}
  ...
  return (
    <aside
      className={`fp-dock${shifted ? " fp-dock--shifted" : ""}`}
      aria-label={t("chrome.dock.title")}
    >
      <div className="fp-dock__head">
        <Settings2 size={13} aria-hidden="true" />
        {t("chrome.dock.title")}
        <button
          type="button"
          className="fp-dock__collapse"
      ...
      <div className="fp-dock__row">
        <span className="fp-dock__label">{t("chrome.dock.language")}</span>
        <select
          className="fp-select"
          value={locale}
      ...
      <div className="fp-dock__row">
        <span className="fp-dock__label">{t("chrome.dock.theme")}</span>
        <button
          type="button"
